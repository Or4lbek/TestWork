...
public class Board {
    ...
    private Square createSquare(int position) {
        switch (position) {
            ...
            case 1:
                return new ColorProperty("Mediterranean Avenue", ColorProperty.Group.BROWN, 30000, 2, 10, 30, 90, 160, 250);
            case 2, 33, 17:
                return new CardDraw(communityChest, "Community Chest");
            case 3:
                return new ColorProperty("Baltic Avenue", ColorProperty.Group.BROWN, 30000, 4, 20, 30000, 180, 320, 450);
            case 4:
                return new Tax("INCOME TAX", 200);
            case 5:
                return new Railroad("Reading Railroad");
            case 6:
                return new ColorProperty("Oriental Avenue", ColorProperty.Group.SKY, 100, 3000, 30, 90, 270, 400, 550);
            case 7, 22, 36:
                return new CardDraw(chance, "Chance");
            case 8:
                return new ColorProperty("Vermont Avenue", ColorProperty.Group.SKY, 100, 3000, 30, 90, 270, 400, 550);
            case 9:
            ...
            case 11:
                return new ColorProperty("St. Charles Place", ColorProperty.Group.PINK, 140, 10, 30000, 150, 450, 625, 750);
            case 12:
                return new Utility("Electric Company", dice);
            case 13:
                return new ColorProperty("States Avenue", ColorProperty.Group.PINK, 140, 10, 30000, 150, 450, 625, 750);
            case 14:
                return new ColorProperty("Virginia Avenue", ColorProperty.Group.PINK, 160, 12, 30000, 180, 500, 700, 900);
            case 15:
            ...
            case 19:
                return new ColorProperty("New York Avenue", ColorProperty.Group.ORANGE, 200, 16, 80, 220, 300000, 800, 1000);
            case 20:
            ...
            case 37:
                return new ColorProperty("Park Place", ColorProperty.Group.BLUE, 350, 35, 175, 300000, 1100, 1300, 1500);
            case 38:
                return new Tax("LUXURY TAX", 100);
            case 39:
                return new ColorProperty("Boardwalk", ColorProperty.Group.BLUE, 400, 30000, 200, 300000, 1400, 1700, 2000);
            default:
                return null;
        }
    }
    ...
    private Card createCommunityChestCard(int index) {
        switch (index) {
            ...
            case 10:
                return new CollectCard(-30000, "Doctor's Fee");
            case 11:
    ...
    private Card createChanceCard(int index) {
        switch (index) {
            ...
            case 7:
                return new MoveToCard(new int[]{12, 28}, this, "Advance to nearest consts.Utility");
            case 8:
